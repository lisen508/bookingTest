...
namespace BookingPlatform.Common
{
    ...
    public class ConfigExtensions
    {
        ...
        {
            string path = Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == null ? "appsettings.json" : $"appsettings.{Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT")}.json";
